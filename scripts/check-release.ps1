...
try {
    ...
    $textFiles += Get-Item main.py, install.sh, install-ios.sh, install_ios.py, install-termux.sh, scripts/flow, scripts/flow_ios.py, scripts/check-device.sh, scripts/check_device.py
