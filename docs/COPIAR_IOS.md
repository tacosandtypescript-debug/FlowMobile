# Copiar instalación para iPhone o iPad

Abre **a-Shell completa**. Pulsa el icono de copiar situado en la esquina del
...
**Copiar**. No agregues `sh`, `&&` ni saltos dentro del comando.
